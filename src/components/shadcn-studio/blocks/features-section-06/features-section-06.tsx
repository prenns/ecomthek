    ...
    <section className='py-8 sm:py-16 lg:py-24'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-12 max-w-6xl space-y-4 text-center md:mb-16 lg:mb-24'>
          ...
          >
           Deine 3 größten Vorteile durch KI-Automatisierung
          </MotionPreset>
          ...
          <MotionPreset
            ...
            transition={{ duration: 0.5 }}
          >
           Konkrete Ergebnisse, die du sofort messen kannst – keine leeren Versprechungen, sondern echte Business-Verbesserungen.
          </MotionPreset>
        </div>
