    ...
    <section className='py-8 sm:py-16 lg:py-24'>
      <div className='mx-auto max-w-7xl space-y-12 px-4 sm:space-y-16 sm:px-6 lg:space-y-24 lg:px-8'>
        ...
        <div className='flex flex-col items-center gap-4 text-center'>
          ...
          >
            So automatisierst du dein Wachstum
          </MotionPreset>

          <MotionPreset fade slide={{ direction: 'down', offset: 50 }} delay={0.3} transition={{ duration: 0.5 }}>
            <p className='text-muted-foreground text-xl'>
              KI-Agenten übernehmen deine operativen Prozesse – von der Datenanalyse bis zur automatischen Entscheidung. Wachse profitabel, ohne dein Team zu verdoppeln.
            </p>
          </MotionPreset>
        </div>
          ...
          <div className='bg-muted grid grid-cols-1 gap-6 rounded-xl p-6 max-sm:p-2 sm:grid-cols-2 lg:grid-cols-6'>
            ...
            >
              <Card className='border-none shadow-none'>
                ...
                <CardHeader className='mt-4 gap-4'>
                  <CardTitle className='text-2xl'>Intelligente Datenanalyse</CardTitle>
                  <CardDescription className='text-lg font-medium'>
                    Echtzeit-Insights aus allen deinen Tools mit automatischen Alerts und Predictive Analytics für bessere Business-Entscheidungen.
                  </CardDescription>
                </CardHeader>
              </Card>
            </MotionPreset>
            ...
            >
              <Card className='justify-between border-none shadow-none lg:col-span-3'>
                <CardContent>
                <PerformanceCard className='w-full' />
                </CardContent>
                <CardHeader className='gap-4'>
                  <CardTitle className='text-2xl'>Messbare Ergebnisse</CardTitle>
                  <CardDescription className='text-lg font-medium'>
                    15+ Stunden pro Woche gespart, 30% weniger operative Kosten und 95% weniger manuelle Reports – sofort messbare ROI-Verbesserungen.
                  </CardDescription>
                </CardHeader>
              </Card>
            </MotionPreset>
            ...
            >
              <Card className='h-full justify-between border-none shadow-none'>
                ...
                <CardHeader className='gap-4'>
                  <CardTitle className='text-2xl'>KI-Agenten im Einsatz</CardTitle>
                  <CardDescription className='text-lg font-medium'>
                    Intelligente Agenten übernehmen 24/7 deiner Routine-Tasks und treffen automatische Entscheidungen basierend auf deinen E-Commerce-Daten.
                  </CardDescription>
                </CardHeader>
              </Card>
            </MotionPreset>
            ...
            >
              <Card className='h-full justify-between border-none shadow-none lg:col-span-2'>
                ...
                <CardHeader className='gap-4'>
                  <CardTitle className='text-2xl'>Automatisierte Workflows</CardTitle>
                  <CardDescription className='text-lg font-medium'>
                    Nahtlose Integration zwischen deinen Tools mit Trigger-basierten Automatisierungen, die 80% deiner manuellen Arbeit eliminieren.
                  </CardDescription>
                </CardHeader>
              </Card>
            </MotionPreset>
            ...
            >
              <Card className='h-full justify-between border-none shadow-none lg:col-span-2'>
                ...
                <CardHeader className='gap-4'>
                  <CardTitle className='text-2xl'>Sichere KI-Integration</CardTitle>
                  <CardDescription className='text-lg font-medium'>
                    Enterprise-Grade Sicherheit mit DSGVO-konformer Datenverarbeitung – deine Daten bleiben geschützt in deinem System.
                  </CardDescription>
                </CardHeader>
              </Card>
            </MotionPreset>
