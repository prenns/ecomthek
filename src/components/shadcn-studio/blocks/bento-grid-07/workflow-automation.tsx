...
// Third-party Imports
import { BrainCircuitIcon, MailIcon } from 'lucide-react'
  ...
  return (
    <div ref={containerRef} className='relative z-1 px-8'>
      <div className='flex flex-col items-center justify-between gap-6'>
        ...
        >
          <Image src='/images/zendesk.png' alt='Zendesk' width={18} height={18} className='size-4.5' />
          <span className='text-card-foreground text-sm'>Neue Kundenanfrage</span>
        </div>
        ...
        <div className='flex items-center justify-between gap-6'>
          <div ref={div3Ref} className='flex w-30 justify-center'>
            <div className='bg-card flex items-center gap-1.5 rounded-full border px-1.5 py-1 shadow-md'>
              ...
              <span className='text-card-foreground text-sm'>Agent</span>
            </div>
          </div>
          <div ref={div4Ref} className='flex w-30 justify-center'>
            <div className='bg-card flex items-center gap-1.5 rounded-full border px-1.5 py-1 shadow-md'>
              <Image src='/images/shopify_glyph_white.png' alt='Shopify' width={18} height={18} className='size-4.5' />
              <span className='text-card-foreground text-sm'>Shopify</span>
            </div>
          </div>
        </div>
        ...
        <div
          ...
          className='bg-card flex w-fit items-center gap-1.5 rounded-full border px-1.5 py-1 shadow-md'
        >
          <Image src='/images/notion.png' alt='Notion' width={18} height={18} className='size-4.5' />
          <span className='text-card-foreground text-sm'>Notion</span>
        </div>
        <div
          ref={div7Ref}
          className='bg-card flex w-fit items-center gap-1.5 rounded-full border px-1.5 py-1 shadow-md'
        >
          ...
          <span className='text-card-foreground text-sm'>Antwort</span>
        </div>
      </div>
